...
def toString(state):
    ...
    row0.extend(row1)
    return ''.join(row0)
# STable for substitution lookup
SBox = [
...
# for this the key will just be the same 128 bits (16 bytes)
key = '0f1571c947d9e8591cb7add6af7f6798'
plain_text = '8123456789abcdeffedcba9876543213'
cypher_text = Encrypt(key, plain_text)
print(f'{cypher_text}')